...
<div class='appArea step_2d' id='step2DArea'>
	...
	<div class="bottom_button_wrap">
		...
		<div class="toolbar">
			<!-- Divider SVG -->
			<!-- <svg width="1" height="36" viewBox="0 0 1 36" fill="none" xmlns="http://www.w3.org/2000/svg" style="margin: 0 8px;">
			...
			<!-- Divider SVG -->
			<button class='secondary_button' data-canvas-help-button='true'>
