<?php 
	$elements = array(
		'suite' => array(
			'name' => 'Suite objects',
			'code' => 'suite',
			'image' => BASE_URL . "/assets/images/suite.png",
		...
		'ceiling' => array(
			'name' => 'Ceiling',
			'code' => 'ceiling',
			'image' => BASE_URL . "/assets/images/2_1_ceiling.jpg",
			'is_move_enabled' => false,
			'is_edit_enabled' => true,
			'is_copy_enabled' => false,
			'is_hide_show_enabled' => false,
...
<div class='element_wrap' data-sidebar-type='<?php echo $element['code'];?>'>
	...
	<div class='heading'>
		...
		<p data-language='sidebar_area_for_each_element_title__<?php echo $element['code'];?>' data-language-original="<?php echo $element['name'];?>">
	...
	<div class='mainWrap'>
		...
		<div class='area area_edit' data-sidebar-edit-area-code='<?php echo $element['code'];?>' data-sidebar-edit-area-type='edit'>
			...
			<div class='apply_button_wrap'>
				<button class='primary_button' data-sidebar-secondary-action-button='edit' data-language='sidebar_input__apply' data-language-original="Apply">
					Apply
				</button>
			</div>
